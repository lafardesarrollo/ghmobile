...
class VacacionPage extends StatefulWidget {
  const VacacionPage({Key? key}) : super(key: key);

  @override
  VacacionPageState createState() => VacacionPageState();
}

class VacacionPageState extends StateMVC<VacacionPage> {
  late VacacionController _con;

  VacacionPageState() : super(VacacionController()) {
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: IconButton(
                        onPressed: () {
                          print(_con.boletas.elementAt(index).idBoleta);
                          // _con.boleta = _con.boletas.elementAt(index);
                          // _con.abrirDetallePermiso(context);
                        },
